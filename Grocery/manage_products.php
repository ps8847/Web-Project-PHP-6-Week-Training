...
switch ($action) {
    case 'add':
        ...
        if ($ext != "jpg" && $ext != "png") {
            ...
            $insertQuery = "INSERT INTO `product`(`productname`, `price`, `discount`, `stock`, `photo`, `description`, `subcategoryid`) VALUES ('$productname','$price ','$discount','$stock','uploads/$org_path','$description','$subcategoryid')";
            // echo $insertQuery;
