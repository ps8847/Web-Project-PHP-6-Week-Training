...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <a class="navbar-brand" href="#" style="font-weight: bolder; color: white; font-size:x-large;"><img class="logo"
                                                                                                        src="images/logo2.jpeg"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <li><a class="dropdown-item text-light" style="font-weight: bold; color: white; " href="repliedquery.php">REPLY'S By Apna Kiryana.com</a></li>
