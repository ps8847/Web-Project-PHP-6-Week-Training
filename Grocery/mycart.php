...
//                    $discountedPrice = round($item->price - (($item->price * $item->discount) / 100), 2);
    ...
    <!-- <form action="insertPayment.php" method="post" id="checkoutForm" class="creditly-card-form agileinfo_form">
        <div class="container">
            <div class="row justify-content-center" style="margin-top: 20px; margin-bottom: 20px;">
                <div class="col-12">
                    <div class="card l-bg-blue-dark">
                        <div class="card-body">
                            <h3 class="card-title" style="text-align: center;">Fill this Form to Place Order</h3>
                            <hr>
                            <div class="col-sm-auto">
                                <div class="form-group">
                                    <label for="address">Enter Address</label>
                                    <textarea id="address" data-rule-required="true" class="form-control"
                                              data-msg-required="*Please enter a valid address so that we can reach you."
                                              name="address" placeholder="Enter full address"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="city">Select City</label>
                                    <div class="controls">
                                        <select name="city" data-rule-required="true" class="option-w3ls form-control"
                                                data-msg-required="*City must be selected." id="town">
                                            <option value="">--Choose City--</option>
                                            <option value="Ajnala">Ajnala</option>
                                            <option value="Amritsar">Amritsar</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <textarea name="remarks" class="form-control" id="remarks" data-rule-required="true"
                                              placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="order-payment-method">
                                        ...
                                        <div class="summary-footer-area">
                                            <div class="custom-control custom-checkbox mb-20">
                                                <input type="checkbox" checked class="custom-control-input" id="terms"/>
                                                <label class="custom-control-label" for="terms">I have read and agree to
                                                    the website <a href="javascript:void(0);">terms and conditions.</a></label>
                                            </div>
                                            <br>
                                            <button class='btn btn-outline-info' type="button" id="placeOrder">
                                                Proceed To Checkout
                                            </button>
                                        </div>
                                    </div>
